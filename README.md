# Fusion Workspace
![GitHub Workflow Status (with event)](https://img.shields.io/github/actions/workflow/status/equinor/fusion-workspace/ci.yml) ![GitHub issues](https://img.shields.io/github/issues/equinor/fusion-workspace)
