...
> A Fusion Workspace app is created relatively quickly. This is not a tutorial or explanation on how to create a 
fusion Workspace but a document explaining the concept of the Workspace app some mocked code examples will be provided.
