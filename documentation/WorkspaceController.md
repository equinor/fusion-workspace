...
The workspace controller is a common hub for all controllers written following the mediator pattern. It facilitates interaction between independent controllers. The idea is for the workspace controller to be pure JS/TS and not be dependent on any JS framework. The Workspace controller will consist of the following.
