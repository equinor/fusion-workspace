import { GardenGroups, GardenGroup } from '../../../Models/data';

const getSubGroupCounts = <T extends unknown>(subGroup: GardenGroup<T>): number => {
...
const getGardenRowCountPerColumn = <T extends unknown>(gardenColumn: GardenGroup<T>): number => {
