...
export const cancel = `<svg fill="${tokens.colors.interactive.primary__resting.hex}" version="1.1" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 32 32">
<title>cancel</title>
