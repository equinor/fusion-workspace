...
export class WorkspaceController<TData, TControllers extends Record<string, any>, TOnClick, TError, TContext> {
	...
	addController = <TController>(
		controller: Controller<TController, WorkspaceController<TData, TControllers, TOnClick, TError, TContext>, TControllers>
	...
	onFilteredDataChanged = (callback: OnDataChangedCallback<TData, TControllers, TOnClick, TError, TContext>): OnCallbackSet =>
		this.addCallback(this.onFilteredDataChangedCallbacks, makeCallback(callback), this.removeOnFilteredDataChangedCallback)
