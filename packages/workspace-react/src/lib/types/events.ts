...
export type OnSidesheetOpenOrClosedCallback<TController> = (
  isOpen: boolean,
  controller: TController
) => void;
/** Function signature for when filter opens or closes */
export type OnFilterOpenOrClosedCallback<TController> = (
  isOpen: boolean,
  controller: TController
) => void;
/** Function signature for when isLoading changes */
export type OnIsLoadingChangedCallback<TController> = (
  isLoading: boolean,
  controller: TController
) => void;
