import { Callback,  OnSidesheetOpenOrClosedCallback } from "../types";
...
export class WorkspaceSidesheetController{
     ...
     */
    onOpenOrClosedChanged = (cb: OnSidesheetOpenOrClosedCallback<this> ) => registerCallback(this.onSidesheetOpenOrClosedCallbacks, cb, this.removeOnSidesheetOpenOrClosedCallback);
    /**
  ...
  type OnWidthChange = (newWidth: number) => void;